...
FactoryBot.define do
  factory :basket do
    ...
    trait :with_static_items do
      after(create) do |basket|
        FactoryBot.create(:line_item, tax_free: true, price: 5.50, basket: basket)
        FactoryBot.create(:line_item, taxable: true, price: 5.50, basket: basket)
        FactoryBot.create(:line_item, taxable: true,
                          imported: true, price: 5.50, basket: basket)
